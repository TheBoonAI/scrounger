        ...
        {assets.map(({ id, name, type }, index) => {
          ...
          return (
            ...
            >
              <button
                type="button"
                className="min-w-full relative bg-gray-900 flex justify-center items-center group"
              ...
              >
                ...
                <button
                  ...
                  className={`absolute top-0 right-0 p-1 m-2 rounded-full bg-gray-800 bg-opacity-75 hover:bg-opacity-100 ${
                    isSimilar
                ...
                >
                  <svg className="fill-current h-6" viewBox="0 0 20 20">
